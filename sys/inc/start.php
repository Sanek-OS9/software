...
$config_bd = include_once H . '/sys/config/db.php';
\Libraries\R::setup('mysql:host=' . $config_bd['host'] . ';dbname=' . $config_bd['db_name'] . '', $config_bd['user'], $config_bd['password']);
if (!\Libraries\R::testConnection()) {
    exit('Нет подключения к базе данных');
}
# заморозка (выключить когда скрипт будет в процессе доработки)
// \Libraries\R::freeze(true);
